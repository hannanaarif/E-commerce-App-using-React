    ...
    <section>
        ...
        {categories.map((category,index)=>(
            <label key={index} className='block mb-2'>
                <input type='radio' name='category' value={category} onChange={()=>handleRadioChangeCategories(category)} className='mr-2 w-4 h-4' checked={selectedCategory===category}/>
        ...
        <button onClick={handleResetFilters}className='w-full mb-16 py-2 bg-black text-white rounded mt-5'>Reset filters</button>
    </section>
    </div>
  )
}
